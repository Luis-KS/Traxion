({  
    ...
    setupDataTable: function (component) {
        component.set('v.columns', [
            ...
            {label: 'Folio Solicitud', fieldName: 'Folio_de_Pedido__c', type: 'text'},
    ...
    searchOLIBySelection : function (component, order) { 
        ...
        const {Folio_del_Pedido__c = null, ID_de_Pedido__c=null, Mostrar_Autorizacion__c=null} = order;
    ...
    renderTitulo : function(component, rowData) {
        const {Tipo_de_Pedido__c = null, Folio_Control__c = null, ID_de_Pedido__c = null, UMUName = null, Creado_Por__r = {}} = rowData; 
    ...
    generatePedidoInWMS : function(component, idPedido) {
        ...
        action.setCallback(this, function(response) { 
            ...
            if (state === "SUCCESS") {
                ...
                if(responseVal.length == 1){
                    const idDePedido = responseVal[0].Id;
                    this.generatePedidoInWMS(component, idDePedido);
                } else if(responseVal.length == 2){ 
                    const idDePedido = responseVal[1].Id;
                    this.generatePedidoInWMS(component, idDePedido);
                }
