...
export default class OpcionesDeOrdenes extends LightningElement {
    ...
    handleSaveProgress(bool) {
        const persistentData = localStorage.getItem('3');
        const parsedData = JSON.parse(persistentData);
        const dataToLoad = {
            selectedUmus: parsedData.selectedUmus,
            isOrdinary: bool
        }
